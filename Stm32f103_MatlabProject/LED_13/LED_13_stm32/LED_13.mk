...
TARGET_PATH = "D:\MATLAB\STM32-~1\STM32"
...
#                        of executable (1/0)?
MODEL                = LED_13
MODULES              = LED_13_ADC.c main.c
MODULES_OBJ          = LED_13_ADC.obj main.obj 
MAKEFILE             = LED_13.mk
...
NUMST                = 2
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 DOWNLOADAPPLICATION=1 STM32CUBEMXPATHUPDATE=1 STM32CUBEMXPATH="C:\Program Files (x86)\STMicroelectronics\STM32Cube\STM32CubeMX" TARGET_INST_FULLPATH="D:\MATLAB\STM32-MAT\STM32" IOC_FULLPATH=".\LED_13.ioc" IT_HANDLER_OPTIM=1 ISPROTECTINGMODEL=NOTPROTECTING STANDALONE_SUPPRESS_EXE=1
MULTITASKING         = 1
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB             = LED_13lib.lib
MODELREF_LINK_LIBS   = 
MODELREF_LINK_RSPFILE     = LED_13_ref.rsp
MODELREF_INC_PATH         =  
...
# Additional includes 
ADD_INCLUDES = \
	-ID:/Matlab_workspace/Stm32f103/LED_13 \
	-ID:/Matlab_workspace/Stm32f103/LED_13/LED_13_stm32 \
	-ID:/MATLAB/STM32-MAT/STM32/addSrc/inc \
...
%.o: $(subst ",,D:/MATLAB/STM32-MAT/STM32/addSrc/src)/%$(ASM_FILE_EXT)
